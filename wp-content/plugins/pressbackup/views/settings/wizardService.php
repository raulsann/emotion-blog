...
<div class="tab_content">
	<form method="post" action="<?php echo $this->router(array('controller'=>'settings', 'function'=>'wizardServiceSave'));?>">

		<h3><?php _e('Storage Service','pressbackup'); ?></h3>
		<p><?php _e('In this step you can configure your storage services to perform backups automatically.','pressbackup'); ?></p><br>
		...
		<hr class="separator"/>
		<input class="button" type="submit" value="<?php _e('Save','pressbackup'); ?>">
	</form>
</div>
